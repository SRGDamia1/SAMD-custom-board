...
This directory contains tools to help users create bootloaders and arduino hardware packages for custom-made SAMD boards.
All you need to do is filling your board info in a plain text config file (just one!),
create variant.h and variant.cpp files describing the pins for Arduino IDE,
...
Detailed instructions are posted in hackaday: <https://hackaday.io/project/193590-arduino-support-for-custom-samd-board>
