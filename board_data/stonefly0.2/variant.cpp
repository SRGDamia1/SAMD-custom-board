...
const PinDescription g_APinDescription[] =
    {
        ...
        {PORTA, 17, PIO_SERCOM, PIN_ATTR_PWM_E, No_ADC_Channel, TC2_CH1, TC2_CH1, EXTERNAL_INT_1}, // D0 UART1 Rx SERCOM1/PAD[1]
        {PORTA, 16, PIO_SERCOM, PIN_ATTR_PWM_E, No_ADC_Channel, TC2_CH0, TC2_CH0, EXTERNAL_INT_0}, // D1 UART1 Tx SERCOM1/PAD[0]
        ...
        {PORTB, 18, PIO_DIGITAL, PIN_ATTR_PWM_F, No_ADC_Channel, TCC1_CH0, NOT_ON_TIMER, EXTERNAL_INT_2},    // D4 GPIO Digital Grove 2
        ...
        {PORTB, 22, PIO_DIGITAL, PIN_ATTR_PWM_E, No_ADC_Channel, TC7_CH0, TC7_CH0, EXTERNAL_INT_6}, // D12 GPIO Digital Feather Left
        ...
        {PORTB, 17, PIO_SERCOM, PIN_ATTR_PWM_E, No_ADC_Channel, TC6_CH1, TC6_CH1, EXTERNAL_INT_1}, // D14 UART4 Bee Rx SERCOM5/PAD[1]
        {PORTB, 16, PIO_SERCOM, PIN_ATTR_PWM_E, No_ADC_Channel, TC6_CH0, TC6_CH0, EXTERNAL_INT_0}, // D15 UART4 Bee Tx SERCOM5/PAD[0]
        ...
        {PORTB, 3, PIO_DIGITAL, (PIN_ATTR_ANALOG | PIN_ATTR_PWM_E), ADC_Channel15, TC6_CH1, TC6_CH1, EXTERNAL_INT_3}, // D25 GPIO Digital Bee RTS (Bee pin 16)
        ...
        {PORTB, 10, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_10}, // D32 SD Card Power
        ...
        // 57..65 - More GPIOs
        {PORTC, 25, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_9},             // D57  GPIO Digital Fuel Gage Alert
        {PORTA, 7, PIO_DIGITAL, (PIN_ATTR_ANALOG | PIN_ATTR_PWM_E), ADC_Channel7, TC1_CH1, NOT_ON_TIMER, EXTERNAL_INT_7}, // D58  GPIO Digital Bee RI (Bee Pin 20)
        {PORTC, 7, PIO_DIGITAL, PIN_ATTR_DIGITAL, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_9},              // D59  GPIO Digital Feather Power Enable
        ...
        {NOT_A_PORT, 0, PIO_NOT_A_PIN, PIN_ATTR_NONE, No_ADC_Channel, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_NONE}, // D79 USB Host enable DOES NOT EXIST ON THIS BOARD

        // 80..81 - VIRTUAL PINS - Alternate use of A9/D75 and A7/D73 as DAC output
        {PORTA, 2, PIO_ANALOG, PIN_ATTR_ANALOG, DAC_Channel0, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_2},            // D80 GPIO Analog DAC/VOUT[0]
        {PORTA, 5, PIO_ANALOG, (PIN_ATTR_ANALOG | PIN_ATTR_PWM_E), DAC_Channel1, TC0_CH1, TC0_CH1, EXTERNAL_INT_5}, // D81 GPIO Analog DAC/VOUT[1]
};
