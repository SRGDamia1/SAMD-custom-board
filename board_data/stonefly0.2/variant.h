...
#define PAD_SPI1_RX SERCOM_RX_PAD_3
    ...
    // static constants for the 2nd SPI pins, you should not need to modify these
...
static const uint8_t BEERX = PIN_SERIAL4_RX;
static const uint8_t BEETX = PIN_SERIAL4_TX;
